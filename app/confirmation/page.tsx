      ...
      <div className="relative min-h-screen flex items-center justify-center px-6 py-24">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="w-20 h-20 rounded-full flex items-center justify-center text-4xl mx-auto mb-8"
            style={{ background: "rgba(232,89,12,0.12)", border: "1px solid rgba(232,89,12,0.2)" }}>
            ✅
          </div>
          ...
          <div className="rounded-2xl p-6 mb-10 text-left space-y-4"
            ...
            <p className="text-xs font-bold uppercase tracking-widest text-orange-400 mb-4">What happens next</p>
            {[
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-black text-base transition-all hover:scale-105 hover:brightness-110 shadow-xl"
            style={{ background: "linear-gradient(135deg, #e8590c, #fbbf24)", boxShadow: "0 0 30px rgba(232,89,12,0.2)" }}
          >
            ← Back to Homepage
          </Link>
        </div>
